...
namespace XyloCode.ThirdPartyServices.YandexMarket.QueryModels
{
    ...
    /// 
    /// </summary>
    public class RegionChildrenListQueryModel : BaseQueryModel
    {
        public override string GetPath() => $"/{version}/geo/regions/{id}/children";

        public RegionChildrenListQueryModel(int regionId)
        {
            id = regionId;
        }
